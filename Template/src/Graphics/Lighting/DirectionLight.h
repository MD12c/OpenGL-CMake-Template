...
public:
    ...
    DirectionLight(GLuint layerIndex, glm::vec3 lightPos, glm::vec3 lightDirection, glm::vec3 lightColor, float left, float right, float bottom, float top, float zNear, float zFar)
        : layerIndex(layerIndex), pos(lightPos), dir(lightDirection), color(lightColor)
    {

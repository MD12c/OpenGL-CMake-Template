...
void ShadowMapCube::BeginDepthPass(ShaderID shaderID, ShadowSystem& shadowSystem, glm::vec3 lightPos)
{
...
void ShadowMapCube::DrawDepthDebug(ShaderID shaderID, int faceIndex)
{
    // ShaderManager::Activate(shaderID);
